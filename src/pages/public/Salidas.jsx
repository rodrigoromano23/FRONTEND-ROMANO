...
export default function Salidas() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-4xl font-bold mb-6 text-center">Salidas</h1>
        ...
        <div key={pub._id} className="mb-10 bg-white shadow-lg rounded-xl overflow-hidden">
          ...
          {pub.type === "video" && pub.videoLink && (
            <div className="p-4">
              <iframe
                width="100%"
                height="315"  // Ajustado para pantallas pequeñas
                src={pub.videoLink}
                title="Video"
                frameBorder="0"
          ...
          {(pub.imageUrl || pub.titulo || pub.descripcion) && (
            <div className="p-4">
              ...
              {pub.imageUrl && (
                <img
                  src={pub.imageUrl}
                  className="w-full h-auto mt-2 rounded-md"  // Ajustado a imagen responsiva
